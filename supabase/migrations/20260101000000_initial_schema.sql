...
-- forward FK from goods.catalog_item_id (goods defined earlier)
ALTER TABLE goods ADD CONSTRAINT goods_catalog_item_id_fkey
  FOREIGN KEY (catalog_item_id) REFERENCES catalog_items(id) ON DELETE SET NULL;

-- FCM 푸시 토큰 (대시보드에서 만들었던 테이블 — 마이그레이션에 누락됨)
